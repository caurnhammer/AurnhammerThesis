...
pdfjam -q	../SPR/plots/rRT_Plaus_Clozedist/RT_est_PlausCloze_distractor.pdf \
...
pdfjam -q   ../SPR/plots/rRT_Plaus_Clozedist/RT_coefficients.pdf \
...
pdfjam -q 	../SPR/plots/rRT_PrecritRT_Plaus_Clozedist/RT_coefficients.pdf \
...
# Observed_Topos_B
pdfjam -q 	--scale 1.5 ../ERP/plots/rERP_Plaus_Clozedist/Topos/Observed_topolegend.pdf \
			--outfile tmp/Observed_topolegend.pdf
pdfjam -q 	../ERP/plots/rERP_Plaus_Clozedist/Topos/Observed_B_250-400.pdf \
...
# Observed_Topos_C
pdfjam -q 	../ERP/plots/rERP_Plaus_Clozedist/Topos/Observed_C_250-400.pdf \
...
# ERP_EstRes_Pz
pdfjam -q   ../ERP/plots/rERP_Plaus_Clozedist/Waveforms/EstimatedPz_InterceptPlausCloze_distractor.pdf \
			../ERP/plots/rERP_Plaus_Clozedist/Waveforms/ResidualPz_InterceptPlausCloze_distractor.pdf \
			--nup 2x1 --landscape \
			--outfile tmp/ERP_EstRes_Pz.pdf \
			--papersize '{8cm,15cm}'
pdfjam -q 	tmp/ERP_EstRes_Pz.pdf \
...
# ERP_Coef_C3Pz
pdfjam -q 	../ERP/plots/rERP_Plaus_Clozedist/Waveforms/Coefficients_C3.pdf \
...
# ERP_Est_Iso_Pz
pdfjam -q 	../ERP/plots/rERP_Plaus_Clozedist/Waveforms/EstimatedPz_InterceptCloze_distractor.pdf \
			../ERP/plots/rERP_Plaus_Clozedist/Waveforms/EstimatedPz_InterceptPlaus.pdf \
			--nup 2x1 --landscape \
			--outfile tmp/ERP_Est_Iso_Pz.pdf \
			--papersize '{8cm,15cm}'

pdfjam -q   tmp/ERP_Est_Iso_Pz.pdf \
			../ERP/plots/rERP_Plaus_Clozedist/Waveforms/EstimatedPz_InterceptPlausCloze_distractor_wavelegend.pdf \
			--delta '0 -80' --nup 1x2 --landscape \
...
pdfjam -q 	../ERP/plots/rERP_Plaus_Clozedist/Topos/Estimated_InterceptCloze_distractor_B_600-1000.pdf \
