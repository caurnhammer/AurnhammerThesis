...
@time process_data("../data/CAPExp.csv", "/data/CAPExp_AC_rERP.csv", models, conds=["A", "C"]);

# Read in processed data.
@time dt = read_data("/data/CAPExp_AC_rERP.csv", models);
...
@time fit_models(dt, models, "/data/CAPExp_AC_rERP");
...
@time process_data("../data/CAPExp.csv", "/data/CAPExp_AC_rERP.csv", models, conds=["A", "C"]);
@time dt = read_data("/data/CAPExp_AC_rERP.csv", models);
@time fit_models(dt, models, "/data/CAPExp_AC_Intercept_rERP");
...
@time process_data("../data/CAPExp.csv", "/data/CAPExp_AC_cloze_rERP.csv", models, invert_preds=[:Cloze], conds=["A", "C"]);
@time dt = read_data("/data/CAPExp_AC_cloze_rERP.csv", models);
@time fit_models(dt, models, "/data/CAPExp_AC_cloze_rERP");
...
@time process_data("../data/CAPExp.csv", "/data/CAPExp_cloze_rcnoun_rERP.csv", models, invert_preds=[:Cloze]);
@time dt = read_data("/data/CAPExp_cloze_rcnoun_rERP.csv", models);
@time fit_models(dt, models, "/data/CAPExp_cloze_rcnoun_rERP");
