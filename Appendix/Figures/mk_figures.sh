...
pdfjam 	../plots/ERP_Design1_AC_CondCode_rERP/Waveforms/Coefficients.pdf \
...
pdfjam 	../plots/ERP_Design1_AC_Cloze_rERP/Waveforms/Coefficients.pdf \
...
pdfjam 	../plots/ERP_Design1_AC_Cloze_rERP/Waveforms/Residual_InterceptCloze.pdf \
		../plots/ERP_Design1_AC_logCloze_rERP/Waveforms/Residual_InterceptlogCloze.pdf \
		--nup 2x1 --landscape \
		--outfile App/ERP_Res_Cloze_logCloze.pdf \
		--papersize '{8cm,15cm}'

pdfjam 	../plots/ERP_Design1_Cloze_Assocnoun_rERP/Waveforms/Observed.pdf \
		../plots/ERP_Design1_Cloze_Assocnoun_rERP/Waveforms/Coefficients.pdf \
		--nup 2x1 --landscape \
		--outfile App/ERP_Data_Coef_Full.pdf \
		--papersize '{8cm,15cm}'

pdfjam	../plots/ERP_Design1_Cloze_Assocnoun_rERP/Waveforms/Estimated_Intercept.pdf                      ../plots/ERP_Design1_Cloze_Assocnoun_rERP/Waveforms/Residual_Intercept.pdf \
...
pdfjam 	../plots/lmerERP_A_logCloze/coefficients.pdf \
...
pdfjam 	--scale 1.5 ../plots/ERP_Design2_Plaus_Clozedist_rERP/Topos/Observed_topolegend.pdf \
		--outfile tmp/Observed_topolegend.pdf
pdfjam	../plots/ERP_Design2_Plaus_Clozedist_rERP/Topos/Estimated_InterceptCloze_distractor_B_600-1000.pdf \
...
pdfjam 	../plots/SPR2_Design1_Cloze_Assocnoun_rRT/Estimated_Intercept.pdf 			    	   ../plots/SPR2_Design1_Cloze_Assocnoun_rRT/Residual_Intercept.pdf \
...
pdfjam 	--scale 2 \
		...
		--papersize '{1cm,15cm}'
pdfjam 	tmp/RT_Est_Res_Full.pdf \
		tmp/Observed_rtlegend.pdf \
		--delta '0 -280' --nup 1x2 --landscape \
		--outfile tmp/RT_Est_Res_Full_2.pdf \
		--papersize '{31cm,15cm}'  
pdfjam 	tmp/RT_Est_Res_Full_2.pdf \
		--landscape \
		--outfile App/RT_Est_Res_Full.pdf \
		--papersize '{29cm,15cm}' \
		--trim '2cm 10cm 2cm 0cm' 

pdfjam 	../plots/SPR2_Design1_Cloze_Assocnoun_across_rRT/Coefficients.pdf \
