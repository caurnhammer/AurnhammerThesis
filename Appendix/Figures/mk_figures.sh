cp ../plots/ERP_Design1_AC_Intercept_rERP/Waveforms/Coefficients.pdf ERP_Coef_Intercept.pdf
	
cp ../plots/ERP_Design1_AC_CondCode_rERP/Waveforms/Observed.pdf ERP_Data_AC.pdf
...
montage -mode concatenate -density 250 \
	...
	-tile 2x4 \
	ERP_Est_Res_Full.pdf

cp ../plots/ERP_Design1_cloze_Assocnoun_across_rERP/Waveforms/t-values.pdf ERP_tval_across.pdf

cp ../plots/ERP_Design1_AC_cloze_rERP/Waveforms/Coefficients_Full.pdf ERP_Coef_Cloze_Grid.pdf

cp ../plots/ERP_Design1_AC_cloze_rERP/Topos/Observed_C_300-500.pdf ERP_Data_AC_Topo.pdf
...
cp ../plots/SPR2_Design1_Cloze_Assocnoun_rRT/Observed.pdf SPR_Observed.pdf
